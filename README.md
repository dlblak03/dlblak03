...
TypeScript, JavaScript, HTML, CSS, C#, SQL  
SvelteKit, TailwindCSS, ASP.NET  
*(Also familiar with: Swift, React Native, Angular)*

**Cloud & DevOps:**  
Azure (ASP.NET, Azure SQL, Azure Identity)  
AWS (Amplify, Cognito, API Gateway, DynamoDB, S3)  
Git, Bash, CI/CD pipelines
